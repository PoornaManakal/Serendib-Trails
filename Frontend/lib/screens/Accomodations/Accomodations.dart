...
class _AccommodationScreenState extends State<AccommodationScreen> {
  ...
  Future<void> _getCurrentPositionAndFetchAccommodations() async {
    try {
      setState(() {
        isLoading = true;
      });
      ...
      if (_currentPosition != null) {
        fetchAccommodations(location: null);
      }
  ...
  Future<void> fetchAccommodations({String? location}) async {
    setState(() {
      isLoading = true;
    });
  ...
  void _selectAutocompleteSuggestion(String description) {
    ...
    _autocompleteResults = [];
    fetchAccommodations(location: description);
  }
  ...
  Future<void> _saveFavoriteAccommodation(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: _getCurrentPositionAndFetchAccommodations,
